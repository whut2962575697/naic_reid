...
class ExemplarMemoryLoss(nn.Module):
    def __init__(self, num_features, num_classes, beta=0.05, knn=6, alpha=0.01,knn_start_epoch=4):
        super(ExemplarMemoryLoss, self).__init__()
        ...
        self.knn_start_epoch = knn_start_epoch
        # Exemplar memory
    ...
    def forward(self, inputs, targets, epoch=None):
        ...
        inputs /= self.beta
        if self.knn > 0 and epoch > self.knn_start_epoch:
